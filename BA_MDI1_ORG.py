...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def createActions(self):
        ...
        self.loginAct = QtGui.QAction(self.tr("&Login"), self)
        self.loginAct.setShortcut(QtGui.QKeySequence(QtCore.Qt.CTRL + QtCore.Qt.Key_L))
        self.loginAct.setStatusTip(self.tr("Login!"))
        self.loginAct.triggered.connect(self.onlogin)
